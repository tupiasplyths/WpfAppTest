...
model_path = "E:/code/J2E_OCR/model_output/checkpoint-2600"
is_local = True
...
class CustomOCR:
    def __init__(self):
        ...
        self.model = VisionEncoderDecoderModel.from_pretrained(model_path, local_files_only=is_local, device_map="cuda")
    ...
    def __call__(self, img_or_path):
        ...
        x = self.model.generate(x.to(self.model.device), max_length=512)
        x = self.processor.decode(x, skip_special_tokens=True)
        x = post_process(x)
